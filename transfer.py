...
# ***** 需要你补充的变量) ******
manual_model_to_smpl ={0: 0, 1: 3, 2: 9, 3: 6, 4: 1, 5: 2, 6: 16, 7: 17, 8: 12, 9: 4,10:5, 11:18, 12:19, 13:15, 14:7, 15:8, 16:20, 17:21}
...
def transfer_one_frame(infofile, use_online_model=False): 
    ...
    with open("./info_seq_5.pkl", "rb") as f: 
        # poses shape: (N, 24, 3)
        poses = pkl.load(f)
...
if __name__ == '__main__':
    ...
    #infofiles = [osp.join("./remy1", _file) for _file in os.listdir("./remy1") if 'out' not in _file and _file.endswith(".txt")]
    #for infofile in infofiles: 
        #transfer_one_frame(infofile)

    # for provided models
    # transfer_one_frame("D:/results/3644.txt")
    transfer_one_sequence("D:/mengpi/9871.txt", "info_seq_5.pkl")

    # for possible model downloaded online
    # clean_info("D:/s/44/Ch44_nonPBR.txt")
    # transfer_one_frame("D:/s/remy1.txt", use_online_model=True)
    # transfer_one_sequence("D:/results/mch11/Ch09_nonPBR/Ch09_nonPBR.txt", "info_seq_5.pkl", use_online_model=True)
